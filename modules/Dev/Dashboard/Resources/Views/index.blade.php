...
@section('content')
    ...
    <div class="row no-gutters font-size-13 margin-bottom-10">
        ...
        <div class="col-4 info-amount padding-20 bg-white margin-bottom-12-p margin-bottom-10 border-radius-3">
            ...
            <p class="amount-show color-444">600,000
                <span> تومان </span></p>
            <p class="title icon-sync">در حال تسویه</p>
            <p class="amount-show color-444">0
                <span> تومان </span></p>
        ...
        <div class="table__box">
            <table width="100%" class="table">
                ...
                <tr role="row">
                    ...
                    <td>
                        <a href="">mohammadnio3@gmail.com</a>
                    </td>
                    <td>
                        <a href="">600,000</a>
                    </td>
                    ...
                    <td>
                        <a href="">خرید دوره - دوره متخصص php سطح مقدماتی</a>
                    </td>
                    <td>
                        <a href=""> 22:14:48 1399/02/23</a>
                    </td>
                    <td>
                        <a href="" class="text-success">پرداخت موفق</a>
                    </td>
                ...
                <tr role="row">
                    ...
                    <td>
                        <a href="">mohammadniko3@gmail.com</a>
                    </td>
                    <td>
                        <a href="">600,000</a>
                    </td>
                    ...
                    <td>
                        <a href="" class="text-error">پرداخت ناموفق</a>
                    </td>
                    <td class="i__oprations">
                        <a href="" class="item-delete margin-left-10" title="حذف"></a>
                        <a href="edit-transaction.html" class="item-edit" title='ویرایش'></a>
